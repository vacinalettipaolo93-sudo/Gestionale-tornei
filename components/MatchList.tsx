// https://github.com/vacinalettipaolo93-sudo/Gestionale-tornei/blob/main/components/MatchList.tsx
...
const MatchCard: React.FC<{ match: Match; player1?: Player; player2?: Player; onEditResult: (match: Match) => void; onBookMatch: (match: Match) => void; isOrganizer: boolean; loggedInPlayerId?: string; onPlayerContact: (player: Player) => void; onRescheduleMatch?: (match: Match) => void; onCancelBooking?: (match: Match) => void; onDeleteResult?: (match: Match) => void; }> = ({ match, player1, player2, onEditResult, onBookMatch, isOrganizer, loggedInPlayerId, onPlayerContact, onRescheduleMatch, onCancelBooking, onDeleteResult }) => {
