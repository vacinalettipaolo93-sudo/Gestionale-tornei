...
interface GruppoRegolamentiProps {
  event: Event;
  tournament: Tournament;
  setEvents: React.Dispatch<React.SetStateAction<Event[]>>;
}

const GruppoRegolamenti: React.FC<GruppoRegolamentiProps> = ({ event, tournament, setEvents }) => {
  ...
  const [rulesText, setRulesText] = useState(selectedGroup?.rules ?? "");
...
export default GruppoRegolamenti;
