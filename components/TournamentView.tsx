    ...
    <div>
      <div className="flex gap-2 mb-6">
        ...
        <button
          ...
          className={`px-4 py-2 rounded-full ${activeTab === 'matches' ? 'bg-gradient-to-r from-indigo-500 to-purple-500 text-white shadow-lg' : 'bg-transparent text-gray-700 hover:bg-gray-100'}`}
        >Partite</button>
        <button
          onClick={() => setActiveTab('players')}
          className={`px-4 py-2 rounded-full ${activeTab === 'players' ? 'bg-gradient-to-r from-indigo-500 to-purple-500 text-white shadow-lg' : 'bg-transparent text-gray-700 hover:bg-gray-100'}`}
        >Giocatori</button>
        <button
          onClick={() => setActiveTab('timeSlots')}
          className={`px-4 py-2 rounded-full ${activeTab === 'timeSlots' ? 'bg-gradient-to-r from-indigo-500 to-purple-500 text-white shadow-lg' : 'bg-transparent text-gray-700 hover:bg-gray-100'}`}
        >Slot Orari</button>
        <button
          onClick={() => setActiveTab('playoffs')}
          className={`px-4 py-2 rounded-full ${activeTab === 'playoffs' ? 'bg-gradient-to-r from-indigo-500 to-purple-500 text-white shadow-lg' : 'bg-transparent text-gray-700 hover:bg-gray-100'}`}
        >Playoff</button>
        <button
          onClick={() => setActiveTab('consolation')}
          className={`px-4 py-2 rounded-full ${activeTab === 'consolation' ? 'bg-gradient-to-r from-indigo-500 to-purple-500 text-white shadow-lg' : 'bg-transparent text-gray-700 hover:bg-gray-100'}`}
        >Consolation</button>
        <button
          onClick={() => setActiveTab('groups')}
          className={`px-4 py-2 rounded-full ${activeTab === 'groups' ? 'bg-gradient-to-r from-indigo-500 to-purple-500 text-white shadow-lg' : 'bg-transparent text-gray-700 hover:bg-gray-100'}`}
        >Gironi</button>
        {isOrganizer && (
          <button
            onClick={() => setActiveTab('settings')}
            className={`px-4 py-2 rounded-full ${activeTab === 'settings' ? 'bg-gradient-to-r from-indigo-500 to-purple-500 text-white shadow-lg' : 'bg-transparent text-gray-700 hover:bg-gray-100'}`}
          >Impostazioni</button>
        )}
        <button
          onClick={() => setActiveTab('chat')}
          className={`px-4 py-2 rounded-full ${activeTab === 'chat' ? 'bg-gradient-to-r from-indigo-500 to-purple-500 text-white shadow-lg' : 'bg-transparent text-gray-700 hover:bg-gray-100'}`}
        >Chat</button>
      </div>
      <div>
