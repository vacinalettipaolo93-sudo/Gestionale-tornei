            ...
            <div>
              {selectedGroup.matches.map(match => (
                <React.Fragment key={match.id}>
                  ...
                  {/* Inline: Modifica Risultato */}
                  {editingMatch && editingMatch.id === match.id && (
                    <div className="bg-secondary border border-highlight rounded-lg p-6 my-4">
                  ...
                  {/* Inline: Prenota Partita */}
                  {bookingMatch && bookingMatch.id === match.id && (
                    <div className="bg-secondary border border-accent rounded-lg p-6 my-4">
                  ...
                  {/* Inline: Modifica Prenotazione */}
                  {reschedulingMatch && reschedulingMatch.id === match.id && (
                    <div className="bg-secondary border border-yellow-400 rounded-lg p-6 my-4">
                  ...
                  {/* Inline: Elimina Risultato */}
                  {deletingMatch && deletingMatch.id === match.id && (
                    <div className="bg-secondary border border-red-600 rounded-lg p-6 my-4">
